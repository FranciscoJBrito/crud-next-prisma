...
const Note = (props: Props) => {
  ...
  return (
    <div className="border-[1px] border-custom-gray overflow-hidden rounded-lg p-4 max-w-full h-28 min-h-fit hover:bg-custom-gray/30 cursor-pointer relative transition-all my-3">
      <h3>{props.title}</h3>
